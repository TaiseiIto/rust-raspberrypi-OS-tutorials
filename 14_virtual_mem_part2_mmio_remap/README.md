...
- `kernel`��Ԃ�`user`��Ԃ𕪗����邽�߂ɂ����K�v�ɂȂ�ύX�̍ŏ��̏W���𓱓�����D
- ��Ղ�address��ԑS�̂̍P���ʑ���p�~���邽�߂�memory mapping�헪�͂�荂�x�Ȃ��̂ɂȂ�D
- ���̑���Cmap�����K�v������͈͂���:
    - `kernel binary`�͍��̂Ƃ���P���ʑ��̂܂�
    - Device `MMIO regions`��device driver��`init()`�œ��ʂȉ��zaddress�͈͂�remap�����D
...
�����tutorial��(����������������ł��낤)`userspace applications`��L���ɂ��邽�߂ɕK�v�ȍŏ��̒i�K���D
...
���̂��߁C��X�����߂�@�\�̂ЂƂ�`kernel`��Ԃ�`user`��Ԃ̊��S�ȕ������D
�K���C`ARMv8`�͂�����������邽�߂֗̕���architecture�x���������Ă���D
�ȉ��̕��Ɛ}���炳��Ȃ闘�_�ƋZ�p��񂪓�����D
_[ARM Cortex-A Series Programmer's Guide for ARMv8-A], Chapter 12.2, Separation of kernel and application Virtual Address spaces_ ����̈��p:
...
> OS�͈�ʂɓ����ɕ�����applications�����tasks�𑖂点��D
> �����͂��ꂼ�ꂪ�Ǝ���translation tables�ƁC����task����ʂ�task�ւ�switching context�̏����̈ꕔ�Ƃ���kernel switches�����D
> �������Cmemory system�̑啔����kernel�݂̂Ɏg���C���zaddress����H�ɕύX�����translation table entries�Ŋ��蓖�Ă�ꂽ����address�ɒ������D
> ARMv8 architecture�͂��̗v���������I�Ɉ����������̋@�\��񋟂���D
>
> Table base address��Translation Table Base Registers `TTBR0_EL1` �� `TTBR1_EL1` �Ŏ��ʂ����D
> `TTBR0` ���w������ translation table �� VA �� upper bits ���S��0�̎��ɑI�΂��D
> `TTBR1` �� VA �� upper bits ���S��1�̎��ɑI�΂��D[...]
>
> �}12-4��kernel��Ԃ�memory�̍ł�address�̑傫�ȗ̈��map����C�eapplication�Ɋ֘A�t����ꂽ���zaddress��Ԃ�memory��address�̏����ȗ̈��map����邱�Ƃ������D
...
���̂�����"[higher half kernel]"�ƌĂ΂��D
�����ꂱ�̕�����B�����邽�߁C����tutorial�͎�n�߂Ɉȉ��̕ύX���s���D
...
1. ��Ղ�address��ԑS�̂��P���ʑ��������ɕK�v�ȕ���������map����D
1. ���̂Ƃ���C`kernel binary`�͍P���ʑ��̂܂܂��Dkernel��remap�͂ƂĂ������ȉۑ�ł��邽�ߍ����tutorials�ŕύX����邾�낤�D
1. Device `MMIO regions`��device driver��`init()`�̊Ԃ�������remap�����D
    1. ����remap�͉��zaddress��Ԃ̐擪�ɔz�u�����D`AArch64 MMU Drive`�ɂ����Đ擪`256 MiB`�����̂��߂Ɋ��蓖�Ă�D
    1. compile���ɉ��zaddress��Ԃ̑傫������`�\���Dremap���ꂽMMIO�̉��zaddress��`7936 MiB` (`0x1_f000_0000`) ����n�܂�悤�ɂƂ肠����`8 GiB`�Ƃ���D
1. ���̂Ƃ���`TTBR0`��kernel translation tables�Ƃ��Ďg��������D�����tutorials��`kernel binary`��remap����ۂɕύX����邾�낤�D
...
���܂ŁC��Ղ�address��ԑS�͍̂P���ʑ����ꂽ�D
kernel�� **architecture** (`src/_arch/_/memory/**`) �̕����� **bsp** (`src/bsp/_/memory/**`) �̕�����translation tables��ݒ肷��� **generic kernel code** (`src/memory/**`) ��ʂ��ĊԐڎQ�Ƃ��邱�ƂȂ��C���ɒ��ړ��삵�Ă����D
...
����𓮂������@�� `architectural MMU code` �� `bsp code` �ɕ���address��Ԃ̎n�_�ƏI�_����ѕ���address��Ԃ̂����ʏ��cacheable DRAM�łȂ��̈��map�����K�v�̂�����ʂȗ̈��₢���킹�邱�Ƃ��D
��������address��ԑS�̂�map���C����ȍ~�Ă�translation tables�ɐG��邱�Ƃ͂Ȃ��D
...
����tutorial�ł̕ύX�ɂ��C **architecture** �� **bsp** ��code�͂��͂⎩���I�ɉ��zmemory mappings�����Ȃ��D
����ɁCkernel�� **generic MMU subsystem code** �ɓ��������D

### A New Mapping API in `src/memory/mmu/translation_table.rs`

First, we define an interface for operating on `translation tables`:

�ŏ��ɁC`translation tables`�𑀍삷�邽�߂�interface���`����D
...
kenrel��translation tables���������邽�߂�generic kernel code ��L�������邽�߂ɁC�ŏ��ɂ�����access�\�ɂ��Ȃ��΂Ȃ�Ȃ��D
���܂ł����� architenture �ŗL�� MMU drive (`src/arch/.../memory/mmu.rs`) �ɂ����ĉB���ꂽ�\���������D
MMU code��table data�\���Ɋ֘A�t���邽�߂ɕK�v�Ȃ�����code���������߂���͈Ӗ����Ȃ����D
���̂��߂�����Ǐ��I��access�\�ɂ��Ă������Ƃ͕������ȒP�ɂ���D
...
tables��kernel code���猩����悤�ɂ���K�v�����邽�߁Ctables��`BSP`code�Ɉړ����邱�Ƃ��d�v���D
�ŏI�I�ɂ�table������Ȃ���΂Ȃ�Ȃ����zaddress��Ԃ̑傫���̂悤��translation table�̑������`����`BSP`�����炾�D
...
������`src/bsp/.../memory/mmu.rs`��global instances region�Œ�`����Ă���D
access�𐧌䂷�邽�߁C������`InitStateLock`�ɂ���ĕی삳���D
...
�\����`KernelTranslationTable`�͓���file�Œ�`���ꂽ�^�ʖ����D���l��`KernelVirtAddrSpace`�^�Ɋ֘A�t����ꂽ�^���炻�̒�`���擾����D`KernelVirtAddrSpace`�͂��ꎩ�g��`memory::mmu::AddressSpace`�^�̌^�ʖ��ł���D
�Ђǂ����G�ɕ�������͕̂������Ă��邪�C���ǂ�`const generics`�̂������̑w�ł����Ȃ��D`const generics`�̎�����`generic`��`arch`��code�ɎU��΂߂��Ă���D
�����(1)�������̋��E�m�F���s�����Ƃɂ��translation table�\���̌��S��compile����`��ۏ؂��邽�߁C(2)generic `MMU` code��`architectural`�����œ��ꉻ���ꂽ���̂̊֌W�𕪗����邽�߂ɂȂ����D

In the end, these tables can be accessed by calling `bsp::memory::mmu::kernel_translation_tables()`:

���ǂ́C������tables��`bsp::memory::mmu::kernel_translation_tables()`���Ăяo�����Ƃ�access�\�ƂȂ�D
...
�Ō�ɁCgeneric kernel code (`src/memory/mmu.rs`)�͂��̎��̂�access����������memory mapping�֐��̑g��񋟂���D
������kernel�̑��̕����Ŏg���邽�߂�export�����D
...
- [`src/bsp/raspberrypi/memory.rs`](src/bsp/raspberrypi/memory.rs) �� [`src/bsp/raspberrypi/link.ld`](src/bsp/raspberrypi/link.ld) ��boot core��stack�̏ꏊ��ύX����D�����data segment�̌�ɒu����Cmap����Ȃ�`guard page`�ɂ���ĕ��������D[`src/_arch/aarch64/exception.rs`](src/_arch/aarch64/exception.rs)��data abort���Ɏ��s���Cfault address��`stack guard page`��ɂ��邩�ǂ����m�F����D�����kernel stack overflow���N�������ǂ����̎w�W�ɂȂ肦��D
- [`src/memory/mmu/types.rs`](src/memory/mmu/types.rs)��`Page<ATYPE>`�Ȃǂ̕K�v�Ȍ^�𓱓�����D
- [`src/memory/mmu/mapping_record.rs`](src/memory/mmu/mapping_record.rs)�͊�����mappings���ė��p(����64KiB page��MMIO�͈͂�����drivers�̏ꍇ)������mappings�̓��v��\�����邽�߂�generic kernel code���ȑO��memory mappings��ǐՂ����i��񋟂���D
...
Kernel��ǂݍ��񂾎��Cdriver��MMIO�̉��zaddress��`0x1_f000_0000`����n�܂邱�Ƃ��m�F�ł���D
