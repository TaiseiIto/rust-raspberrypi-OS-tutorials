...
- `kernel`ãÛä‘Ç∆`user`ãÛä‘Çï™ó£Ç∑ÇÈÇΩÇﬂÇ…Ç¢Ç¬Ç©ïKóvÇ…Ç»ÇÈïœçXÇÃç≈èâÇÃèWçáÇì±ì¸Ç∑ÇÈÅD
- äÓî’ÇÃaddressãÛä‘ëSëÃÇÃçPìôé ëúÇîpé~Ç∑ÇÈÇΩÇﬂÇ…memory mappingêÌó™ÇÕÇÊÇËçÇìxÇ»Ç‡ÇÃÇ…Ç»ÇÈÅD
- ÇªÇÃë„ÇÌÇËÅCmapÇ≥ÇÍÇÈïKóvÇ™Ç†ÇÈîÕàÕÇæÇØ:
    - `kernel binary`ÇÕç°ÇÃÇ∆Ç±ÇÎçPìôé ëúÇÃÇ‹Ç‹
    - Device `MMIO regions`ÇÕdevice driverÇÃ`init()`Ç≈ì¡ï Ç»âºëzaddressîÕàÕÇ…remapÇ≥ÇÍÇÈÅD
...
ç°âÒÇÃtutorialÇÕ(âìÇ¢è´óàé¿åªÇ∑ÇÈÇ≈Ç†ÇÎÇ§)`userspace applications`ÇóLå¯Ç…Ç∑ÇÈÇΩÇﬂÇ…ïKóvÇ»ç≈èâÇÃíiäKÇæÅD
...
Ç±ÇÃÇΩÇﬂÅCâ‰ÅXÇ™ãÅÇﬂÇÈã@î\ÇÃÇ–Ç∆Ç¬ÇÕ`kernel`ãÛä‘Ç∆`user`ãÛä‘ÇÃäÆëSÇ»ï™äÑÇæÅD
çKÇ¢ÅC`ARMv8`ÇÕÇ±ÇÍÇé¿åªÇ∑ÇÈÇΩÇﬂÇÃï÷óòÇ»architectureéxâáÇéùÇ¡ÇƒÇ¢ÇÈÅD
à»â∫ÇÃï∂Ç∆ê}Ç©ÇÁÇ≥ÇÁÇ»ÇÈóòì_Ç∆ãZèpèÓïÒÇ™ìæÇÁÇÍÇÈÅD
_[ARM Cortex-A Series Programmer's Guide for ARMv8-A], Chapter 12.2, Separation of kernel and application Virtual Address spaces_ Ç©ÇÁÇÃà¯óp:
...
> OSÇÕàÍî Ç…ìØéûÇ…ï°êîÇÃapplicationsÇ®ÇÊÇ—tasksÇëñÇÁÇπÇÈÅD
> Ç±ÇÍÇÁÇÕÇªÇÍÇºÇÍÇ™ì∆é©ÇÃtranslation tablesÇ∆ÅCÇ†ÇÈtaskÇ©ÇÁï ÇÃtaskÇ÷ÇÃswitching contextÇÃèàóùÇÃàÍïîÇ∆ÇµÇƒkernel switchesÇéùÇ¬ÅD
> ÇµÇ©ÇµÅCmemory systemÇÃëÂïîï™ÇÕkernelÇÃÇ›Ç…égÇÌÇÍÅCâºëzaddressÇ©ÇÁãHÇ…ïœçXÇ≥ÇÍÇÈtranslation table entriesÇ≈äÑÇËìñÇƒÇÁÇÍÇΩï®óùaddressÇ…íºÇ≥ÇÍÇÈÅD
> ARMv8 architectureÇÕÇ±ÇÃóvãÅÇå¯ó¶ìIÇ…àµÇ§Ç¢Ç≠Ç¬Ç©ÇÃã@î\ÇíÒãüÇ∑ÇÈÅD
>
> Table base addressÇÕTranslation Table Base Registers `TTBR0_EL1` Ç∆ `TTBR1_EL1` Ç≈éØï Ç≥ÇÍÇÈÅD
> `TTBR0` Ç™éwÇµé¶Ç∑ translation table ÇÕ VA ÇÃ upper bits Ç™ëSÇƒ0ÇÃéûÇ…ëIÇŒÇÍÇÈÅD
> `TTBR1` ÇÕ VA ÇÃ upper bits Ç™ëSÇƒ1ÇÃéûÇ…ëIÇŒÇÍÇÈÅD[...]
>
> ê}12-4ÇÕkernelãÛä‘Ç™memoryÇÃç≈Ç‡addressÇÃëÂÇ´Ç»óÃàÊÇ…mapÇ≥ÇÍÅCäeapplicationÇ…ä÷òAïtÇØÇÁÇÍÇΩâºëzaddressãÛä‘Ç™memoryÇÃaddressÇÃè¨Ç≥Ç»óÃàÊÇ…mapÇ≥ÇÍÇÈÇ±Ç∆Çé¶Ç∑ÅD
...
Ç±ÇÃÇ‚ÇËï˚ÇÕ"[higher half kernel]"Ç∆åƒÇŒÇÍÇÈÅD
Ç¢Ç∏ÇÍÇ±ÇÃï™ó£ÇíBê¨Ç∑ÇÈÇΩÇﬂÅCÇ±ÇÃtutorialÇÕéËénÇﬂÇ…à»â∫ÇÃïœçXÇçsÇ§ÅD
...
1. äÓî’ÇÃaddressãÛä‘ëSëÃÇçPìôé ëúÇ∑ÇÈë„ÇÌÇËÇ…ïKóvÇ»ïîï™ÇæÇØÇmapÇ∑ÇÈÅD
1. ç°ÇÃÇ∆Ç±ÇÎÅC`kernel binary`ÇÕçPìôé ëúÇÃÇ‹Ç‹ÇæÅDkernelÇÃremapÇÕÇ∆ÇƒÇ‡ìÔÇµÇ≠äÔñ≠Ç»â€ëËÇ≈Ç†ÇÈÇΩÇﬂç°å„ÇÃtutorialsÇ≈ïœçXÇ≥ÇÍÇÈÇæÇÎÇ§ÅD
1. Device `MMIO regions`ÇÕdevice driverÇÃ`init()`ÇÃä‘Ç‰Ç¡Ç≠ÇËÇ∆remapÇ≥ÇÍÇÈÅD
    1. Ç±ÇÃremapÇÕâºëzaddressãÛä‘ÇÃêÊì™Ç…îzíuÇ≥ÇÍÇÈÅD`AArch64 MMU Drive`Ç…Ç®Ç¢ÇƒêÊì™`256 MiB`ÇÇ±ÇÃÇΩÇﬂÇ…äÑÇËìñÇƒÇÈÅD
    1. compileéûÇ…âºëzaddressãÛä‘ÇÃëÂÇ´Ç≥Ç™íËã`â¬î\ÇæÅDremapÇ≥ÇÍÇΩMMIOÇÃâºëzaddressÇ™`7936 MiB` (`0x1_f000_0000`) Ç©ÇÁénÇ‹ÇÈÇÊÇ§Ç…Ç∆ÇËÇ†Ç¶Ç∏`8 GiB`Ç∆Ç∑ÇÈÅD
1. ç°ÇÃÇ∆Ç±ÇÎ`TTBR0`Çkernel translation tablesÇ∆ÇµÇƒégÇ¢ë±ÇØÇÈÅDç°å„ÇÃtutorialsÇ≈`kernel binary`ÇremapÇ∑ÇÈç€Ç…ïœçXÇ≥ÇÍÇÈÇæÇÎÇ§ÅD
...
ç°Ç‹Ç≈ÅCäÓî’ÇÃaddressãÛä‘ëSëÃÇÕçPìôé ëúÇ≥ÇÍÇΩÅD
kernelÇÃ **architecture** (`src/_arch/_/memory/**`) ÇÃïîï™Ç∆ **bsp** (`src/bsp/_/memory/**`) ÇÃïîï™ÇÕtranslation tablesÇê›íËÇ∑ÇÈä‘ **generic kernel code** (`src/memory/**`) Çí ÇµÇƒä‘ê⁄éQè∆Ç∑ÇÈÇ±Ç∆Ç»Ç≠ÅCã§Ç…íºê⁄ìÆçÏÇµÇƒÇ¢ÇΩÅD
...
Ç±ÇÍÇìÆÇ©Ç∑ï˚ñ@ÇÕ `architectural MMU code` Ç™ `bsp code` Ç…ï®óùaddressãÛä‘ÇÃénì_Ç∆èIì_Ç®ÇÊÇ—ï®óùaddressãÛä‘ÇÃÇ§Çøí èÌÇÃcacheable DRAMÇ≈Ç»Ç¢óÃàÊÇ…mapÇ≥ÇÍÇÈïKóvÇÃÇ†ÇÈì¡ï Ç»óÃàÊÇñ‚Ç¢çáÇÌÇπÇÈÇ±Ç∆ÇæÅD
Ç±Ç§ÇµÇƒaddressãÛä‘ëSëÃÇmapÇµÅCÇ±ÇÍà»ç~çƒÇ—translation tablesÇ…êGÇÍÇÈÇ±Ç∆ÇÕÇ»Ç¢ÅD
...
Ç±ÇÃtutorialÇ≈ÇÃïœçXÇ…ÇÊÇËÅC **architecture** Ç∆ **bsp** ÇÃcodeÇÕÇ‡ÇÕÇ‚é©ìÆìIÇ…âºëzmemory mappingsÇçÏÇÁÇ»Ç¢ÅD
ë„ÇÌÇËÇ…ÅCkernelÇÃ **generic MMU subsystem code** Ç…ìùçáÇ≥ÇÍÇÈÅD

### A New Mapping API in `src/memory/mmu/translation_table.rs`

First, we define an interface for operating on `translation tables`:

ç≈èâÇ…ÅC`translation tables`ÇëÄçÏÇ∑ÇÈÇΩÇﬂÇÃinterfaceÇíËã`Ç∑ÇÈÅD
...
kenrelÇÃtranslation tablesÇèàóùÇ∑ÇÈÇΩÇﬂÇÃgeneric kernel code ÇóLå¯âªÇ∑ÇÈÇΩÇﬂÇ…ÅCç≈èâÇ…Ç±ÇÍÇÁÇaccessâ¬î\Ç…ÇµÇ»ÇØÇŒÇ»ÇÁÇ»Ç¢ÅD
ç°Ç‹Ç≈Ç±ÇÍÇÁÇÕ architenture å≈óLÇÃ MMU drive (`src/arch/.../memory/mmu.rs`) Ç…Ç®Ç¢ÇƒâBÇ≥ÇÍÇΩç\ë¢ÇæÇ¡ÇΩÅD
MMU codeÇ™table dataç\ë¢Ç…ä÷òAïtÇØÇÈÇΩÇﬂÇ…ïKóvÇ»ÇæÇØÇÃcodeÇæÇ¡ÇΩÇΩÇﬂÇ±ÇÍÇÕà”ñ°ÇÇ»ÇµÇΩÅD
ÇªÇÃÇΩÇﬂÇ±ÇÍÇã«èäìIÇ…accessâ¬î\Ç…ÇµÇƒÇ®Ç≠Ç±Ç∆ÇÕï®éñÇä»íPÇ…Ç∑ÇÈÅD
...
tablesÇÕkernel codeÇ©ÇÁå©Ç¶ÇÈÇÊÇ§Ç…Ç∑ÇÈïKóvÇ™Ç†ÇÈÇΩÇﬂÅCtablesÇ`BSP`codeÇ…à⁄ìÆÇ∑ÇÈÇ±Ç∆Ç™èdóvÇæÅD
ç≈èIìIÇ…ÇÕtableÇ™ï¢ÇÌÇ»ÇØÇÍÇŒÇ»ÇÁÇ»Ç¢âºëzaddressãÛä‘ÇÃëÂÇ´Ç≥ÇÃÇÊÇ§Ç»translation tableÇÃëÆê´ÇíËã`Ç∑ÇÈ`BSP`ÇæÇ©ÇÁÇæÅD
...
Ç±ÇÍÇÁÇÕ`src/bsp/.../memory/mmu.rs`ÇÃglobal instances regionÇ≈íËã`Ç≥ÇÍÇƒÇ¢ÇÈÅD
accessÇêßå‰Ç∑ÇÈÇΩÇﬂÅCÇ±ÇÍÇÁÇÕ`InitStateLock`Ç…ÇÊÇ¡Çƒï€åÏÇ≥ÇÍÇÈÅD
...
ç\ë¢ëÃ`KernelTranslationTable`ÇÕìØÇ∂fileÇ≈íËã`Ç≥ÇÍÇΩå^ï ñºÇæÅDìØólÇ…`KernelVirtAddrSpace`å^Ç…ä÷òAïtÇØÇÁÇÍÇΩå^Ç©ÇÁÇªÇÃíËã`ÇéÊìæÇ∑ÇÈÅD`KernelVirtAddrSpace`ÇÕÇªÇÍé©êgÇ™`memory::mmu::AddressSpace`å^ÇÃå^ï ñºÇ≈Ç†ÇÈÅD
Ç–Ç«Ç≠ï°éGÇ…ï∑Ç±Ç¶ÇÈÇÃÇÕï™Ç©Ç¡ÇƒÇ¢ÇÈÇ™ÅCåãã«ÇÕ`const generics`ÇÃÇ¢Ç≠Ç¬Ç©ÇÃëwÇ≈ÇµÇ©Ç»Ç¢ÅD`const generics`ÇÃé¿ëïÇÕ`generic`Ç∆`arch`ÇÃcodeÇ…éUÇËÇŒÇﬂÇÁÇÍÇƒÇ¢ÇÈÅD
Ç±ÇÍÇÕ(1)Ç¢Ç≠Ç¬Ç©ÇÃã´äEämîFÇçsÇ§Ç±Ç∆Ç…ÇÊÇËtranslation tableç\ë¢ÇÃåíëSÇ»compileéûíËã`Çï€èÿÇ∑ÇÈÇΩÇﬂÅC(2)generic `MMU` codeÇ∆`architectural`ïîï™Ç≈ì¡éÍâªÇ≥ÇÍÇΩÇ‡ÇÃÇÃä÷åWÇï™ó£Ç∑ÇÈÇΩÇﬂÇ…Ç»Ç≥ÇÍÇÈÅD

In the end, these tables can be accessed by calling `bsp::memory::mmu::kernel_translation_tables()`:

åãã«ÇÕÅCÇ±ÇÍÇÁÇÃtablesÇÕ`bsp::memory::mmu::kernel_translation_tables()`ÇåƒÇ—èoÇ∑Ç±Ç∆Ç≈accessâ¬î\Ç∆Ç»ÇÈÅD
...
ç≈å„Ç…ÅCgeneric kernel code (`src/memory/mmu.rs`)ÇÕÇ±ÇÃé¿ëÃÇ…accessÇµèàóùÇ∑ÇÈmemory mappingä÷êîÇÃëgÇíÒãüÇ∑ÇÈÅD
Ç±ÇÍÇÁÇÕkernelÇÃëºÇÃïîï™Ç≈égÇÌÇÍÇÈÇΩÇﬂÇ…exportÇ≥ÇÍÇÈÅD
...
Ç±ÇÃtutorialï∂Ç≈ÇÕàµÇÌÇÍÇƒÇ¢Ç»Ç¢ïœçXÇ™Ç¢Ç≠Ç¬Ç©Ç†ÇÈÇ™ÅCì«é“ÇÕÇ≈Ç´ÇÍÇŒÇ±ÇÍÇÁÇó¨Çµì«Ç›Ç∑Ç◊Ç´ÇæÅD
...
- [`src/bsp/raspberrypi/memory.rs`](src/bsp/raspberrypi/memory.rs) Ç∆ [`src/bsp/raspberrypi/link.ld`](src/bsp/raspberrypi/link.ld) ÇÕboot coreÇÃstackÇÃèÍèäÇïœçXÇ∑ÇÈÅDÇ±ÇÍÇÕdata segmentÇÃå„Ç…íuÇ©ÇÍÅCmapÇ≥ÇÍÇ»Ç¢`guard page`Ç…ÇÊÇ¡Çƒï™äÑÇ≥ÇÍÇÈÅD[`src/_arch/aarch64/exception.rs`](src/_arch/aarch64/exception.rs)ÇÕdata abortéûÇ…é¿çsÇµÅCfault addressÇ™`stack guard page`è„Ç…Ç†ÇÈÇ©Ç«Ç§Ç©ämîFÇ∑ÇÈÅDÇ±ÇÍÇÕkernel stack overflowÇ™ãNÇ´ÇΩÇ©Ç«Ç§Ç©ÇÃéwïWÇ…Ç»ÇËÇ¶ÇÈÅD
- [`src/memory/mmu/types.rs`](src/memory/mmu/types.rs)ÇÕ`Page<ATYPE>`Ç»Ç«ÇÃïKóvÇ»å^Çì±ì¸Ç∑ÇÈÅD
- [`src/memory/mmu/mapping_record.rs`](src/memory/mmu/mapping_record.rs)ÇÕä˘ë∂ÇÃmappingsÇçƒóòóp(ìØÇ∂64KiB pageÇ…MMIOîÕàÕÇéùÇ¬driversÇÃèÍçá)ÇµÇΩÇËmappingsÇÃìùåvÇï\é¶Ç∑ÇÈÇΩÇﬂÇ…generic kernel codeÇ™à»ëOÇÃmemory mappingsÇí«ê’Ç∑ÇÈéËíiÇíÒãüÇ∑ÇÈÅD
...
KernelÇì«Ç›çûÇÒÇæéûÅCdriverÇÃMMIOÇÃâºëzaddressÇ™`0x1_f000_0000`Ç©ÇÁénÇ‹ÇÈÇ±Ç∆ÇämîFÇ≈Ç´ÇÈÅD
...
[MP] ‚è© Pushing 67 KiB =========================================ü¶Ä 100% 0 KiB/s Time: 00:00:00
...
[ML] Requesting binary
[MP] ‚è© Pushing 74 KiB =========================================ü¶Ä 100% 0 KiB/s Time: 00:00:00
[ML] Loaded! Executing the payload now
